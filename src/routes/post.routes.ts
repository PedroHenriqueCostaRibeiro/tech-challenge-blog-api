...
import { ensureAuth, ensureRole } from "../middlewares/ensureAuth";
...
const onlyTeachers = ensureRole("teacher");

router.post("/", ensureAuth, onlyTeachers, (req, res, next) =>
  postController.store(req, res, next)
);
router.put("/:id", ensureAuth, onlyTeachers, (req, res, next) =>
  postController.update(req, res, next)
);
router.delete("/:id", ensureAuth, onlyTeachers, (req, res, next) =>
